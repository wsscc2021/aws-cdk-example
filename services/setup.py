...
setuptools.setup(
    ...
    install_requires=[
        ...
        "aws-cdk.aws_eks==1.115.0",
        "aws-cdk.aws_elasticloadbalancingv2==1.115.0",
        "aws-cdk.aws_autoscaling==1.115.0",
        "aws-cdk.aws_rds==1.115.0",
        "aws-cdk.aws_efs==1.115.0",
        "aws-cdk.aws_elasticache==1.115.0",
